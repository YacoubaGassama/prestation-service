...
public class PaiementCreateRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private uahb.m1gl.kafka.avro.model.PaiementStatut paiementStatut;
   ...
   */
  public PaiementCreateRequestAvroModel(java.lang.String clientId, java.lang.String demandeId, java.math.BigDecimal montant, java.lang.String message, uahb.m1gl.kafka.avro.model.PaiementStatut paiementStatut) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: paiementStatut = (uahb.m1gl.kafka.avro.model.PaiementStatut)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public uahb.m1gl.kafka.avro.model.PaiementStatut getPaiementStatut() {
   ...
   * @param value the value to set.
   */
  public void setPaiementStatut(uahb.m1gl.kafka.avro.model.PaiementStatut value) {
   ...
   */
  public static uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder newBuilder() {
    return new uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder();
  }
   ...
   * @return A new PaiementCreateRequestAvroModel RecordBuilder
   */
  public static uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder newBuilder(uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder other) {
    if (other == null) {
      return new uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder();
    } else {
      return new uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaiementCreateRequestAvroModel RecordBuilder
   */
  public static uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder newBuilder(uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel other) {
    if (other == null) {
      return new uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder();
    } else {
      return new uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaiementCreateRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.clientId)) {
        this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder clearClientId() {
      clientId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder setDemandeId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder clearDemandeId() {
      demandeId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder setMontant(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder clearMontant() {
      montant = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder clearMessage() {
      message = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder setPaiementStatut(uahb.m1gl.kafka.avro.model.PaiementStatut value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateRequestAvroModel.Builder clearPaiementStatut() {
      paiementStatut = null;
    ...
    public PaiementCreateRequestAvroModel build() {
      try {
        ...
        record.paiementStatut = fieldSetFlags()[4] ? this.paiementStatut : (uahb.m1gl.kafka.avro.model.PaiementStatut) defaultValue(fields()[4]);
        return record;
