...
public class PaiementCreateResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public PaiementCreateResponseAvroModel(java.lang.String clientId, java.lang.String demandeId, java.lang.String message, uahb.m1gl.kafka.avro.model.PaiementStatut paiementStatut) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: paiementStatut = (uahb.m1gl.kafka.avro.model.PaiementStatut)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder newBuilder() {
    return new uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder();
  }
   ...
   * @return A new PaiementCreateResponseAvroModel RecordBuilder
   */
  public static uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder newBuilder(uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder other) {
    if (other == null) {
      return new uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder();
    } else {
      return new uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaiementCreateResponseAvroModel RecordBuilder
   */
  public static uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder newBuilder(uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel other) {
    if (other == null) {
      return new uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder();
    } else {
      return new uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaiementCreateResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.clientId)) {
        this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder clearClientId() {
      clientId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder setDemandeId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder clearDemandeId() {
      demandeId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder clearMessage() {
      message = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder setPaiementStatut(uahb.m1gl.kafka.avro.model.PaiementStatut value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.PaiementCreateResponseAvroModel.Builder clearPaiementStatut() {
      paiementStatut = null;
    ...
    public PaiementCreateResponseAvroModel build() {
      try {
        ...
        record.paiementStatut = fieldSetFlags()[3] ? this.paiementStatut : (uahb.m1gl.kafka.avro.model.PaiementStatut) defaultValue(fields()[3]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.paiementStatut = uahb.m1gl.kafka.avro.model.PaiementStatut.values()[in.readEnum()];
